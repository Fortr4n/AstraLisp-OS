...
(defun sys-link (oldpath newpath) (declare (ignore oldpath newpath)) 0)
(defun sys-unlink (pathname) (declare (ignore pathname)) 0)
(defun sys-rename (oldpath newpath) (declare (ignore oldpath newpath)) 0)
(defun sys-mkdir (pathname mode) (declare (ignore pathname mode)) 0)
(defun sys-rmdir (pathname) (declare (ignore pathname)) 0)
(defun sys-chdir (path) (declare (ignore path)) 0)
(defun sys-fchdir (fd) (declare (ignore fd)) 0)
(defun sys-getcwd (buf size) (declare (ignore buf size)) 0)
(defun sys-dup (fd) (declare (ignore fd)) 0)
(defun sys-dup2 (oldfd newfd) (declare (ignore oldfd newfd)) 0)
(defun sys-pipe (pipefd) (declare (ignore pipefd)) 0)
(defun sys-readv (fd iov iovcnt) (declare (ignore fd iov iovcnt)) 0)
(defun sys-writev (fd iov iovcnt) (declare (ignore fd iov iovcnt)) 0)
(defun sys-pread64 (fd buf count offset) (declare (ignore fd buf count offset)) 0)
(defun sys-pwrite64 (fd buf count offset) (declare (ignore fd buf count offset)) 0)
(defun sys-stat (pathname statbuf) (declare (ignore pathname statbuf)) 0)
(defun sys-fstat (fd statbuf) (declare (ignore fd statbuf)) 0)
(defun sys-access (pathname mode) (declare (ignore pathname mode)) 0)
(defun sys-chmod (pathname mode) (declare (ignore pathname mode)) 0)
(defun sys-fchmod (fd mode) (declare (ignore fd mode)) 0)
(defun sys-chown (pathname owner group) (declare (ignore pathname owner group)) 0)
(defun sys-fchown (fd owner group) (declare (ignore fd owner group)) 0)
(defun sys-lchown (pathname owner group) (declare (ignore pathname owner group)) 0)
(defun sys-umask (mask) (declare (ignore mask)) 0)
(defun sys-truncate (path length) (declare (ignore path length)) 0)
(defun sys-ftruncate (fd length) (declare (ignore fd length)) 0)
(defun sys-msync (addr length flags) (declare (ignore addr length flags)) 0)
(defun sys-mlock (addr length) (declare (ignore addr length)) 0)
(defun sys-munlock (addr length) (declare (ignore addr length)) 0)
(defun sys-mlockall (flags) (declare (ignore flags)) 0)
(defun sys-munlockall () 0)
(defun sys-mremap (old-addr old-size new-size flags new-addr)
  (declare (ignore old-addr old-size new-size flags new-addr)) 0)
(defun sys-rt-sigpending (set sigsetsize) (declare (ignore set sigsetsize)) 0)
(defun sys-sigsuspend (mask) (declare (ignore mask)) 0)
(defun sys-rt-sigsuspend (mask sigsetsize) (declare (ignore mask sigsetsize)) 0)
(defun sys-sigpending (set) (declare (ignore set)) 0)
(defun sys-sigaltstack (ss oss) (declare (ignore ss oss)) 0)
(defun sys-pause () 0)
(defun sys-settimeofday (tv tz) (declare (ignore tv tz)) 0)
(defun sys-clock-settime (clk-id tp) (declare (ignore clk-id tp)) 0)
(defun sys-clock-getres (clk-id res) (declare (ignore clk-id res)) 0)
(defun sys-clock-nanosleep (clk-id flags req rem) (declare (ignore clk-id flags req rem)) 0)
(defun sys-alarm (seconds) (declare (ignore seconds)) 0)
(defun sys-setitimer (which new-value old-value) (declare (ignore which new-value old-value)) 0)
(defun sys-getitimer (which curr-value) (declare (ignore which curr-value)) 0)
(defun sys-socket (domain type protocol) (declare (ignore domain type protocol)) 0)
(defun sys-bind (sockfd addr addrlen) (declare (ignore sockfd addr addrlen)) 0)
(defun sys-connect (sockfd addr addrlen) (declare (ignore sockfd addr addrlen)) 0)
(defun sys-listen (sockfd backlog) (declare (ignore sockfd backlog)) 0)
(defun sys-accept (sockfd addr addrlen) (declare (ignore sockfd addr addrlen)) 0)
(defun sys-send (sockfd buf len flags) (declare (ignore sockfd buf len flags)) 0)
(defun sys-recv (sockfd buf len flags) (declare (ignore sockfd buf len flags)) 0)
(defun sys-sendto (sockfd buf len flags dest-addr addrlen) (declare (ignore sockfd buf len flags dest-addr addrlen)) 0)
(defun sys-recvfrom (sockfd buf len flags src-addr addrlen) (declare (ignore sockfd buf len flags src-addr addrlen)) 0)
(defun sys-sendmsg (sockfd msg flags) (declare (ignore sockfd msg flags)) 0)
(defun sys-recvmsg (sockfd msg flags) (declare (ignore sockfd msg flags)) 0)
(defun sys-shutdown (sockfd how) (declare (ignore sockfd how)) 0)
(defun sys-getsockopt (sockfd level optname optval optlen) (declare (ignore sockfd level optname optval optlen)) 0)
(defun sys-setsockopt (sockfd level optname optval optlen) (declare (ignore sockfd level optname optval optlen)) 0)
(defun sys-getsockname (sockfd addr addrlen) (declare (ignore sockfd addr addrlen)) 0)
(defun sys-getpeername (sockfd addr addrlen) (declare (ignore sockfd addr addrlen)) 0)
(defun sys-socketpair (domain type protocol sv) (declare (ignore domain type protocol sv)) 0)
(defun sys-setpgid (pid pgid) (declare (ignore pid pgid)) 0)
(defun sys-getpgid (pid) (declare (ignore pid)) 0)
(defun sys-getpgrp () 0)
(defun sys-setsid () 1)
(defun sys-getsid (pid) (declare (ignore pid)) 0)
(defun sys-sched-setparam (pid param) (declare (ignore pid param)) 0)
(defun sys-sched-getparam (pid param) (declare (ignore pid param)) 0)
(defun sys-sched-setscheduler (pid policy param) (declare (ignore pid policy param)) 0)
(defun sys-sched-getscheduler (pid) (declare (ignore pid)) 0)
(defun sys-sched-setaffinity (pid cpusetsize mask) (declare (ignore pid cpusetsize mask)) 0)
(defun sys-sched-getaffinity (pid cpusetsize mask) (declare (ignore pid cpusetsize mask)) 0)
(defun sys-getpriority (which who) (declare (ignore which who)) 0)
(defun sys-setpriority (which who prio) (declare (ignore which who prio)) 0)
(defun sys-sync () 0)
(defun sys-fsync (fd) (declare (ignore fd)) 0)
(defun sys-fdatasync (fd) (declare (ignore fd)) 0)
(defun sys-ioctl (fd request arg) (declare (ignore fd request arg)) 0)
(defun sys-fcntl (fd cmd arg) (declare (ignore fd cmd arg)) 0)
(defun sys-select (nfds readfds writefds exceptfds timeout) (declare (ignore nfds readfds writefds exceptfds timeout)) 0)
(defun sys-poll (fds nfds timeout) (declare (ignore fds nfds timeout)) 0)
(defun sys-getdents (fd dirp count) (declare (ignore fd dirp count)) 0)
(defun sys-uname (buf) (declare (ignore buf)) 0)
(defun sys-sysinfo (info) (declare (ignore info)) 0)

;;; Helper Functions

(defun get-register (context reg-num)
  "Get register from exception context."
  (declare (ignore context reg-num))
  0)
